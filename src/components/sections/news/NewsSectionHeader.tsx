    ...
    <div className="flex items-center justify-between gap-6">
      <div className="flex items-center gap-4">
        ...
        <div className="">
          ...
          <div className="text-[15px] text-[#383838] mt-[-2px]">{subtitle}</div>
        </div>
      </div>
      <Link className="flex items-center gap-2.5 text-[15px] font-semibold text-[#cecece] hover:text-[#0071ef]" href={href}>
        <span>查看全部</span>
