        ...
        >
          ...
          >
            ...
            >
              ...
              <Link
                ...
                className="absolute duration-300 hover:scale-105 "
                style={{
                  width: "200px",
                  height: "42px",
                  left: "870px",
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center w-full h-full pt-8">
              ...
              {/* --- 第一组：公众号 --- */}
              {/* 二维码 1 */}
              <div className="relative w-[180px] h-[180px] mb-4 shadow-sm">
                <Image
              ...
              {/* 小标题 1 */}
              <div className="text-[16px] font-bold text-black h-[24px] flex items-center mb-1">
                DeltaX迭代未来微信公众号
              </div>

              {/* 渐变横线 1 */}
              <div
                className="rounded-[25px] mb-1"
                style={{
                  width: "196px",
                  height: "3px",
                  background: "linear-gradient(90deg, #0071EF 0%, #149BFF 100%)",
              ...
              {/* 橙色解释文字 1 */}
              <div className="text-[13px] font-bold text-[#FF8706] h-[20px] flex items-center mb-8">
                订阅新鲜资讯及活动通知
              </div>
              ...
              {/* 橙色解释文字 2 */}
              <div className="text-[13px] font-bold text-[#FF8706] h-[20px] flex items-center mb-12">
                项目投递 / 商务合作 / 约个coffee chat
              </div>

            {/* 使用说明书按钮 */}
            <Link
              href="https://ucns4q7cn89b.feishu.cn/wiki/MSMDwy1mhirIJCkiICrc0GSSnyd?from=from_parent_docx"
              className="absolute bg-black rounded-[15px] flex items-center justify-center text-white duration-300 hover:scale-105 z-20"
              style={{
                width: "210px",
                height: "90px",
                left: "25px",
