    ...
    >
      ...
      <div className="mx-auto relative flex h-full w-full max-w-[1440px] flex-col justify-between px-[44px] pb-[34px] pt-[44px] md:px-[62px] md:pt-[50px]">
        <div>
          ...
          <p className="mt-[14px] text-[14px] font-bold leading-none">邮箱: contact@zjuxlab.com</p>

          <div className="mt-[24px] flex items-start gap-[20px]">
            <div className="flex flex-col items-center">
              <div className="flex h-[70px] w-[70px] items-center justify-center overflow-hidden bg-white">
                <Image
                  src="/assets/footer/gzh.png"
                  alt="公众号二维码"
                  width={70}
                  height={70}
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-[7px] text-[9px] font-bold leading-none">X-Lab小助手</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-end justify-between gap-8">
          ...
          <div className="hidden flex-shrink-0 items-end gap-3 md:flex">
            <div className="mb-[2px] h-[52px] w-[52px] p-[4px]">
              <Image
                src={FOOTER_LOGO}
                alt="X-Lab logo"
                width={44}
