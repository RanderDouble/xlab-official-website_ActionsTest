...
export const FEATURED_NEWS: NewsItem[] = [
  ...
  {
    id: 2,
    title: "活动报名丨“Z+” 科创训练营五期来了，培育未来独角兽！",
    date: "2026-02-05",
    type: "image",
  ...
  },
  {
    ...
    date: "2026-01-22",
    type: "image",
    imageUrl: "/assets/news/latest/3.png",
    summary: "敢想敢做，破局而生",
    category: "新闻",
...
export const NEWS_LIST: NewsItem[] = [
  {
    id: 101,
    title: "硬件课题成果登上IEEE顶级期刊（IF=46.7）！",
    date: "2025-07-01",
    type: "text",
    summary:
      "X-Lab学生团队自主动手实践，用“磁”科技打造包容性生命体征监测设备。",
    category: "成果",
...
export const NEWS_HERO = {
  ...
  imageSrc: "/assets/news/hero1.png",
...
export const HOME_LAB_NEWS_IMAGE: LabNews[] = [
  {
    ...
    date: "2026-02-05",
    summary: "学生创新成果获得国家级媒体关注与报道",
    imageUrl: "/assets/home/news/101.jpeg",
    link: "https://mp.weixin.qq.com/s/qDJXkOk-lscy-Swql28NbQ",
  },
  {
    id: 102,
  ...
  },
  {
    ...
    date: "2025-12-28",
    summary: "成为花猫学习中心首批AI生态伙伴",
    imageUrl: "/assets/home/news/104.png",
    link: "https://mp.weixin.qq.com/s/n3YcDWVRcvXn6oot29JmBQ",
  },
  {
    id: 105,
